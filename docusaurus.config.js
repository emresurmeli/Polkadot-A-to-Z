    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl: 'https://github.com/emresurmeli/Polkadot-A-to-Z',
        },
        blog: {
          showReadingTime: true,
          blogSidebarTitle: 'A to Z',
          blogSidebarCount: 'ALL',
          // Please change this to your repo.
          editUrl:
            'https://github.com/emresurmeli/Polkadot-A-to-Z',
        },
        theme: {
  ...
  themeConfig:
    ...
    ({
      navbar: {
        ...
        logo: {
          alt: 'My Site Logo',
          src: 'img/polkadot-symbol-svgs/Polkadot_symbol_black.svg',
        },
        items: [
          // {
          //   type: 'doc',
